...
source=("${_pkgname}.sh" "${_pkgname}.desktop"
        ...
        "https://github.com/jm2/archlinux-package-codwaw-wine-steam/raw/master/CoDWaWlf.exe"
...
sha256sums=('d6039965a738de62d7d310ff429ebff93948751de341a9d5ae5e57b755635bf9'
            ...
            '16ff3bb33af41b9d4d59e47df7e6e6074b27d54801714464af0eaba2af1e64f4'
...
package() {
    ...
    cp $srcdir/CoDWaW{,lf,mp}.exe $pkgdir/opt/${_pkgname}/
